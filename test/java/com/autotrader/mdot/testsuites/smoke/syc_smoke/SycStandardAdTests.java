 ...
 */
public class SycStandardAdTests {
    ...
    /**
     * Preliminary Tests (Navigate to Standard Ad Selection)
     *
     */
    ...
    public void shouldBeAbleToClickStandardAdAndVerifyItsPage() throws InterruptedException{
    ...
    public void shouldSelectFiveDaysUpsEnhancement() throws InterruptedException{
//        assertTrue(sycEnhanceYourAdPage.checkOnCorrectPage());
//        sycEnhanceYourAdPage.waitForObject();
//        sycEnhanceYourAdPage.clickExtendYourRun();
    }

    @Test(dependsOnMethods = {"shouldSelectFiveDaysUpsEnhancement"})
